...
| 主类 | 模板文件 |
|------|----------|
| 01 | `lumis/01-personal-experience/_template.md` |
| 02 | `lumis/02-industry-resources/_template.md` |
| 03 拆解 | `lumis/03-benchmark-accounts/_template-benchmark.md` |
| 03 视频 | video-to-knowledge 标准笔记格式 |
| 04 | `lumis/04-viral-topics/_template.md` |
| 05 | `lumis/05-user-questions/_template.md` |
| 06 | `lumis/06-product-info/_template.md` |
| 07 | `lumis/07-platform-rules/_template.md` |
